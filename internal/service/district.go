...
type IDistrictService interface {
	...
	GetDistrictByCityId(cityID int) ([]*model.GetDistrictResponse, error)
}
...
func (d *DistrictService) GetDistrictByCityId(cityID int) ([]*model.GetDistrictResponse, error) {
	var res []*model.GetDistrictResponse

	districts, err := d.DistrictRepository.GetDistrictByCityId(cityID)
	if err != nil {
		return nil, err
	}
